...
public class SkipList<E extends Comparable<E>>{
    ...
    /**
     * iterator of skiplist that i have written
     */

    private class SkipListIter implements Iterator<E> {
        private SLNode<E> current;
        private SLNode<E> lastItemReturned;
        private Stack<SLNode<E>> backWards;

        public SkipListIter() {
            this.current = head;
            backWards=new Stack<SLNode<E>>();
        ...
        public E next() {
            if(!hasNext()) {
                System.out.println("You reached the Head!");
                return current.data;
            }
            lastItemReturned=current;
            current=backWards.pop();
            //System.out.println("c="+current.data);
            //System.out.println("l="+lastItemReturned.data);
            return current.data;
        }
    }
    ...
    /**
     * This method constructs iterator with delegation
     */
    public void iteratorConstructor(){
        this.iter=new SkipListIter();
    }

    /**
     * This method calls next method of the iterator with delegation
     * @return
     */
    public E next(){
        if(!iter.hasNext())
    ...
    /**
     * Overloading
     * It removes Highest element of SkipList by using iterator
     * @return true
     */
