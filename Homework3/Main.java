...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BranchEmployee branchEmployee4=new BranchEmployee("Mehmet", "Saray", "111111", "mehmetsaray@abc.com");
        ...
        KWArrayList<Integer> furnitureQuantityArray1=new KWArrayList<Integer>();
        furnitureQuantityArray1.add(100);
        furnitureQuantityArray1.add(100);
        furnitureQuantityArray1.add(100);
        furnitureQuantityArray1.add(100);
        furnitureQuantityArray1.add(100);
        //int[] furnitureQuantityArray2={75,75,75,75,75};
        KWArrayList<Integer> furnitureQuantityArray2=new KWArrayList<Integer>();
        furnitureQuantityArray2.add(75);
        furnitureQuantityArray2.add(75);
        furnitureQuantityArray2.add(75);
        furnitureQuantityArray2.add(75);
        furnitureQuantityArray2.add(75);
        //int[] furnitureQuantityArray3={50,50,50,50,50};
        KWArrayList<Integer> furnitureQuantityArray3=new KWArrayList<Integer>();
        furnitureQuantityArray3.add(50);
        furnitureQuantityArray3.add(50);
        furnitureQuantityArray3.add(50);
        furnitureQuantityArray3.add(50);
        furnitureQuantityArray3.add(50);
        //int[] furnitureQuantityArray4={100,80,60,40,20};
        KWArrayList<Integer> furnitureQuantityArray4=new KWArrayList<Integer>();
        furnitureQuantityArray4.add(100);
        furnitureQuantityArray4.add(80);
        furnitureQuantityArray4.add(60);
        furnitureQuantityArray4.add(40);
        furnitureQuantityArray4.add(20);
        //int[] furnitureQuantityArray5={80,60,40,20,0};
        KWArrayList<Integer> furnitureQuantityArray5=new KWArrayList<Integer>();
        furnitureQuantityArray5.add(80);
        furnitureQuantityArray5.add(60);
        furnitureQuantityArray5.add(40);
        furnitureQuantityArray5.add(20);
        furnitureQuantityArray5.add(0);
                        ...
                        switch(employeeTransaction)
                        {
                            case'1':
                                ...
                                else if(employeeBranchTransaction=='2')
                                {
                                    ...
                                    int branchIndex=input.nextInt();
                                    admin.getBranchList().get(branchIndex).showAllStock();
                                }
                                else if(employeeBranchTransaction=='3')
                                {
                                    ...
                                    KWArrayList<Integer> productQuantityArray=new KWArrayList<Integer>(5);
                                    productQuantityArray.add(redProductNumber);
                                    productQuantityArray.add(blueProductNumber);
                                    productQuantityArray.add(blackProductNumber);
                                    productQuantityArray.add(greyProductNumber);
                                    productQuantityArray.add(whiteProductNumber);
                                    ...
                                    admin.showAllBranch();
                                    int branchIndex=input.nextInt();
                                    admin.getBranchList().get(branchIndex).addFurniture(newFurniture);
                                    admin.getBranchList().get(branchIndex).showAllStock();
                                }
                                else if(employeeBranchTransaction=='4')
                                {
                                    ...
                                    admin.getBranchList().get(branchIndexRemove).removeFurniture(productNameRemove, productModelRemove);
                                }
                                ...
                                else if(employeeBranchTransaction=='6')
                                {
                                    ...
                                    admin.getBranchList().get(branchIncreaseIndex).showAllStock();
                                    ...
                                    admin.getBranchList().get(branchIncreaseIndex).increaseQuantity(productIncreaseIndex, productIncreaseColorIndex, productIncreaseAmount);
                                ...
                                else if(employeeBranchTransaction=='7')
                                {
                                    ...
                                    admin.getBranchList().get(branchDecreaseIndex).showAllStock();
                                    ...
                                    admin.getBranchList().get(branchDecreaseIndex).decreaseQuantity(productDecreaseIndex, productDecreaseColorIndex, productDecreaseAmount);
                            ...
                            case '2':
                                ...
                                if(branchUserTransaction=='1')
                                {
                                    ...
                                    userdatabase.getBranchEmployeeArray().get(realEmployeeIndex).subscribeCustomer(newcustomer, userdatabase);
                                }
                                else if(branchUserTransaction=='2')
                                {
                                    ...
                                    userdatabase.getBranchEmployeeArray().get(realEmployeeIndex).removeCustomer(customerMailRemove, userdatabase);
                                }
                                else if(branchUserTransaction=='3')
                                {
                                    ...
                                    admin.getBranchList().get(purchaseBranchIndex).showAllStock();
                                    ...
                                    userdatabase.getBranchEmployeeArray().get(realEmployeeIndex).purchaseProduct(admin.getBranchList().get(purchaseBranchIndex),
                                            userdatabase.getCustomerArray().get(customerIndex),customersPhoneNumber,customersAdress,purchaseProductIndex,purchaseAmount,purchaseColorIndex);
                                }
                                else if(branchUserTransaction=='4')
                                {
                                    ...
                                    String customersMail=input.next();
                                    int customerIndex=userdatabase.getCustomerIndex(customersMail);
                                    userdatabase.getCustomerArray().get(customerIndex).checkOrders();
                                ...
                                else if(branchUserTransaction=='5')
                                {
                                    ...
                                    userdatabase.getBranchEmployeeArray().get(realEmployeeIndex).updateOrderSituation(userdatabase.getCustomerArray().get(customerIndex), orderIndex, newSituation);
                                }
                                else
                                {
                                    System.out.println("Please enter a valid number between 1-5");
                    ...
                    while(innerLoopController2!=1)
                    {
                        ...
                        switch(customerTransaction)
                        {
                            ...
                            case'3':
                                ...
                                admin.getBranchList().get(branchPurchaseIndex).showAllStock();
                                ...
                                admin.getBranchList().get(branchPurchaseIndex).sell(userdatabase.getCustomerArray().get(customerIndex), customerPhonenumber, customerAdress, productPurchaseIndex, amountPurchase, colorPurchaseIndex);
                                break;
                            case'4':
                                System.out.println("Returning to Main Menu...");
